...
// ตัวอย่างข้อมูลสินค้า (ในระบบจริงจะมาจากฐานข้อมูล)
$products = [
...
// เพิ่มสินค้าในตะกร้า (จาก shop.php หรือหน้าอื่น)
  ...
  <form method="post">
    <table>
      ...
      <tr>
        ...
        <td><a href="?remove=<?= $id ?>" class="btn">ลบ</a></td>
      </tr>
      <?php endforeach; ?>
    </table>
    ...
    <div class="actions">
      ...
      <a href="checkout.php" class="btn">สั่งซื้อ</a>
    </div>

    <div class="total">
      ยอดรวมสุทธิ: <strong><?= number_format($total, 2) ?> บาท</strong>
    </div>
  </form>
  <?php else: ?>
